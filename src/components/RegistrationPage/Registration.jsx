...
const Registration = () => {
  return (
    ...
    <div className="form-group">
      ...
      <input type="text" id="age" className="form-input" placeholder="Your age"/>
    </div>

    <div className="form-group">
      <label for="school" className="form-label">School Name:</label>
      <input type="text" id="school" className="form-input" placeholder="Your school Name"/>
    </div>
